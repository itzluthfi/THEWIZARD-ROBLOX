...
def run_mcp(calls, wait=2):
    ...
    send({"jsonrpc":"2.0","id":1,"method":"initialize","params":{
        ...
        "clientInfo":{"name":"list-instances","version":"1"}}})
    time.sleep(0.3)
...
calls = [
    {"name": "search_game_tree", "arguments": {"path": "ServerScriptService", "max_depth": 5}},
    {"name": "search_game_tree", "arguments": {"path": "ReplicatedStorage", "max_depth": 5}}
]
out, err = run_mcp(calls, wait=4)
for line in out:
    try:
        obj = json.loads(line)
